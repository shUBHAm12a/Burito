const menuCategories = {
  ...
  sides: {
    name: "Sides",
    items: [
      { name: "Fries", price: "$5.90", vegan: true },
      { name: "Loaded Cheese Fries", price: "$9.90", vegan: false },
      { name: "Spicy Loaded Fries 🌶️", price: "$12.90", vegan: false },
      { name: "Street-Style Loaded Corn Chips", price: "$11.90", vegan: false },
      { name: "Jalapeño Cheese Bites (6)", price: "$6.90", vegan: false },
      { name: "Broccoli Cheese Bites (6)", price: "$10.90", vegan: false },
      { name: "Cauliflower Bites (6)", price: "$7.90", vegan: false },

      { name: "Corn & Cheese Quesadilla", price: "$8.90", vegan: false },
      { name: "Corn Chips & Guacamole", price: "$8.90", vegan: true },
      { name: "Corn Chips & Salsa Roja", price: "$6.90", vegan: true },
      { name: "Corn Chips", price: "$4.90", vegan: true },
      { name: "Side of Guacamole", price: "$3.00", vegan: true },
      { name: "Side of Salsa Roja", price: "$2.00", vegan: true },
      { name: "Side of Sour Cream", price: "$2.50", vegan: false },
      { name: "Side of Rice", price: "$3.00", vegan: true },
    ],
    customizable: false,
  },
  drinks: {
    ...
    items: [
      ...
      { name: "COKE CLASSIC 330ML", price: "$3.50" },
      { name: "COKE NO SUGAR 330ML", price: "$3.50" },
      { name: "SPRITE 330ML", price: "$3.50" },
      { name: "SPRITE ZERO SUGAR 330ML", price: "$3.50" },
      { name: "FANTA ORANGE 330ML", price: "$3.50" },
      { name: "L & P 330ML", price: "$3.50" },
      { name: "PEPSI 330ML", price: "$3.50" },
      { name: "JARRITOS MEXICAN COLA 370ML", price: "$7.00" },
      { name: "JARRITOS MANGO 370ML", price: "$7.00" },
      { name: "JARRITOS GUAVA 370ML", price: "$7.00" },
      { name: "JARRITOS PINEAPPLE 370ML", price: "$7.00" },
      { name: "JARRITOS MANDARIN 370ML", price: "$7.00" },
      { name: "BUNDABERG GINGER BEER 375ML", price: "$5.50" },
      { name: "BUNDABERG LEMON, LIME & BITTERS 375ML", price: "$5.50" },
      { name: "BUNDABERG GUAVA 375ML", price: "$5.50" },
      { name: "GREEN V GUARANA ENERGY DRINK 250ML", price: "$4.50" },
      { name: "BLUE V GUARANA ENERGY DRINK 250ML", price: "$4.50" },
      { name: "WATER BOTTLE - PURE NZ SPRING", price: "$2.50" },
    ],
  },
};
